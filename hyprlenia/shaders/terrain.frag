...
const vec3 BASE_COLOR = vec3(0.05, 0.08, 0.15);     
const vec3 GRID_COLOR = vec3(0.1, 0.2, 0.3);        
const vec3 GLOW_COLOR_1 = vec3(0.1, 0.5, 1.0);      
const vec3 GLOW_COLOR_2 = vec3(0.0, 1.0, 0.5);      
const vec3 GLOW_COLOR_3 = vec3(1.0, 0.3, 0.5);      
const vec3 HIGHLIGHT = vec3(1.0, 1.0, 1.0);         
...
void main() {
    ...
    float species = vFieldData.b * 3.0;  
